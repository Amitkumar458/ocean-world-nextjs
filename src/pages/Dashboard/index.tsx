      ...
      <MotionBox duration={2} stiffness={45} damping={8}>
        <div className="flex flex-col sm:flex-row items-center">
          ...
          <div className="w-100 sm:mx-4 lg:mx-0 lg:mr-4 text-center gradient-text">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold  m-2">
              Interactive gamified approach to ocean literacy
            </h1>
            <h1 className="text-xl lg:text-2xl font-bold">
              Learn about the oceans in a fun way, play games, and discover how
              to protect and keep our environment clean for future generations.
            </h1>
          </div>
        </div>
        <h1 className="text-4xl m-4 text-center">More About Game</h1>
